                ...
                <div class="card-body">
                    <form @submit.prevent="updateEmployee">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="first_name" v-model="form.first_name" type="text" class="form-control" v-bind:class="{ 'is-invalid': errors.first_name }" name="first_name" value="" required autocomplete="first_name" autofocus>
