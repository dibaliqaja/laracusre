    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <a href="{{ route('user.create') }}" class="btn btn-primary">Add new user</a><br><br>
                    </div>
                    <div class="col-md-4">
                        <form action="#" class="flex-sm">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <button onclick="window.location.href='{{ route('user.index') }}'" type="button" class="btn btn-md btn-secondary rounded"><i class="fas fa-sync-alt"></i></button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <tbody>
                        @forelse ($users as $user => $result)
                            <tr>
                                <td>{{ $user + $users->firstitem() }}</td>
                                <td align="center">                             
                                    <a href="{{ route('user.edit', $result->id) }}" type="button" class="btn btn-sm btn-info"><i class="fas fa-pen"></i></a>                                
            ...
            <form action="javascript:void(0)" id="deleteForm" method="post">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="vcenter">Delete User</h4>
